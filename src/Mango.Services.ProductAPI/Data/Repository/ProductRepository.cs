namespace Mango.Services.ProductAPI.Data.Repository
{
	public class ProductRepository : IProductRepository
	{
		...
		public async Task<CreateProductModel> CreateProduct(CreateProductModel data)
		{
			...
			return result > 0 ? data : new CreateProductModel();
		}
		...
		public async Task<UpdateProductModel> UpdateProduct(UpdateProductModel data)
		{
			...
			if (product != null)
			{
				...
				return result > 0 ? data : new UpdateProductModel();
			}
